  ...
  const course = [
    {
      ...
      details2: [
        ...
        <div>
          ...
          We develop websites using popular CMS platforms like WordPress,
          Joomla, and Drupal, enabling you to manage and update your content
          easily without any technical expertise.
        </div>,
        ...
        <Box textAlign="center">
          ...
          >
            <Breadcrumbs aria-label="breadcrumb">
              ...
              >
                <Box sx={{ color: "black" }}>{project?.title}</Box>
              </Link>
            </Breadcrumbs>
          </Box>
        </Box>
