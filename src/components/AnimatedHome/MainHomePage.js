...
import p11 from "../../assets/images/placementPartners/p11.png";
...
const MainHomePage = () => {
    ...
    const companyImgArray = [p1, p2, p3, p4, p5,  p7, p10 , p11];
    ...
    const placementPartners = [p1, p2, p3, p4, p5,  p7, p8, p9, p10 , p11];
